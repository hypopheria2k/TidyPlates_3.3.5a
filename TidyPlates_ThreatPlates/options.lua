...
HideFriendlyHealthbar = {
    ...
    desc = L["Hide healthbars on friendly units."],
    type = "toggle",
    order = 3,
    width = "double",
    get = GetValue,
...
HideFriendlyNames = {
    ...
    desc = "Also hide the names of friendly units. Only class icons will be shown.",
    type = "toggle",
    order = 4,
    width = "double",
    get = GetValue,
    set = SetValue,
    arg = {"hideFriendlyNames"},
    disabled = function() return not (db.classWidget.ON and db.hideFriendlyHealthbar) end,
    hidden = function() return not db.hideFriendlyHealthbar end,
},
										FriendlyCaching = {
											name = L["Friendly Caching"],
											type = "toggle",
